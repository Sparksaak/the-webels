    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1">
        <section className="w-full py-20 md:py-32 lg:py-40 xl:py-48 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl 2xl:max-w-none">
      ...
      <footer className="bg-background border-t">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl 2xl:max-w-none flex flex-col gap-4 sm:flex-row py-6 w-full shrink-0 items-center">
